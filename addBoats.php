...
//reservations cannot be made more than 30 days in advance, so boats are only created out 30 days - ensure time zeroed for comparisons
$maxDay = new DateTime($today);
$maxDay->modify('+30 day');

//query to get furthest boat in the future
$dateQuery = $conn->query("SELECT DISTINCT departDate FROM boatsDNW WHERE departDate >= '" . $today . "' ORDER BY departDate DESC");
...
//takes a date object, returns a boolean, 1 if between memorial and labor day, 0 if not
...
while ($dateDate <= $maxDay){
	...
	$normalBoats = "INSERT INTO boatsDNW(departDate, departAnacortes, departDecatur) VALUES('".$dateString."', '10:00', '11:00'), ('".$dateString."', '16:00', '17:00')";
	$fridayBoats = "INSERT INTO boatsDNW(departDate, departAnacortes, departDecatur) VALUES('".$dateString."', '10:00', '11:00'), ('".$dateString."', '16:00', '17:00'), ('".$dateString."', '19:30', '20:30')";
